...
import com.yalantis.ucrop.SelectImageActivity;
...
public class BitmapLoadTask extends AsyncTask<Void, Void, BitmapLoadTask.BitmapWorkerResult> {
    ...
    protected void onPostExecute(@NonNull BitmapWorkerResult result) {
        if (result.mBitmapWorkerException == null) {
            ...
            mBitmapLoadCallback.onBitmapLoaded(result.mBitmapResult, result.mExifInfo, SelectImageActivity.Companion.getInput(), (mOutputUri == null) ? null : SelectImageActivity.Companion.getOutput());
        } else {
